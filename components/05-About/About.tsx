    ...
    `}
      ...
      `}>
        ...
        <p className={css`
          ...
          font-weight: 500;
        `}>Аква Сана — чиста питна вода. Мембранна технологія очищення, без застосування хімічних реагентів. Устаткування провідних американських компаній. Процес очищення повністю автоматизований, що виключає людський фактор. Постійний контроль і регулярні лабораторні дослідження гарантують 100% якість. Очищена від всіх шкідливих домішок, солей жорсткості, бактерій і вірусів. Процес насичення озоном — дезінфікує, збагачує киснем і надає нашій воді свіжий і неповторний смак гірського струмка. Придатна для пиття без кип’ятіння і додаткової обробки.</p>
      </div>
    </section>
  )
}
